...
if [ -f "cards/${PROCESS}/shower_card.dat" ]; then
	echo ">> File cards/${PROCESS}/shower_card.dat already exists, it will not be modified"
else
	echo ">> File cards/${PROCESS}/shower_card.dat does not exist, copying from ${MG_DIR}/${PROCESS}/Cards/shower_card_default.dat"
	cp "${MG_DIR}/${PROCESS}/Cards/shower_card_default.dat" "cards/${PROCESS}/shower_card.dat"
fi
