...
#include "HiggsTemplateCrossSectionsStage1p1.h"
...
namespace Rivet {
  ...
  class HiggsTemplateCrossSectionsStage1p1 : public Analysis {
  public:
    // Constructor
    HiggsTemplateCrossSectionsStage1p1()
      : Analysis("HiggsTemplateCrossSectionsStage1p1"),
  ...
  public:
    ...
    void init() {
      printf("==============================================================\n");
      printf("========     HiggsTemplateCrossSectionsStage1p1 Initialization     =========\n");
      printf("==============================================================\n");
  ...
  DECLARE_RIVET_PLUGIN(HiggsTemplateCrossSectionsStage1p1);
  //#endif
